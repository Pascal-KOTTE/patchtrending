    ...
    class SiteGenerator {
        ...
        public static int GeneratePage(DataTable t, string pagename, string bulletin) {
            ...
            foreach (DataRow r in t.Rows) {
                ...
                drawChart.AppendLine("\t\tvar " + curr_dat + "_0 = google.visualization.arrayToDataTable(formatDateString("
                                                                                            + curr_bul + "_0, 0));");
                ...
                drawChart.AppendLine("\t\tvar " + curr_dat + "_1 = google.visualization.arrayToDataTable(formatDateString(" 
                                                                                            + curr_bul + "_1, 0));");
                drawChart.AppendLine("\t\tvar " + curr_gra +
